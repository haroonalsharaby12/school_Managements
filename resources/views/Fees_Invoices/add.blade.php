                                        ...
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <select class="fancyselect form-control" name="student_id" required>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="box">
                                                        <select class="fancyselect form-control" name="fee_id" required>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="box">
                                                        <select class="fancyselect form-control" name="amount" required>
                                                            <option value="">-- اختار من القائمة --</option>
                                                            @foreach($fees as $fee)
