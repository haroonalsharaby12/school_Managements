...
namespace App\Http\Controllers\parent_dashboard;
...
class ChildrenController extends Controller
{
    ...
    public function attendanceSearch(Request $request)
    {
        ...
        $ids = DB::table('teacher_section')->where('teacher_id', auth()->guard('parent')->user()->id)->pluck('section_id');
    ...
    public function fees(){
        $students_ids = Student::where('parent_id', auth()->guard('parent')->user()->id)->pluck('id');
